...
@section('content')
    <div class="mt-3 pb-3">
        ...
        <p class="text-right">修訂日期：2016年09月04日</p>
        <div class="card">
            <div class="card-block">
                ...
                <p>
                    本站會儲存使用者的資料，包括學號、姓名、系級、性別、打卡項目及時間、抽獎券編號等，所有資料僅供課外組於抽獎後核對使用，不會顯示給非擁有者。課外組及本社全體工作人員禁止於非活動必要狀況下公開任何使用者資料，亦不得挪作他用或交給第三方單位。</p>
