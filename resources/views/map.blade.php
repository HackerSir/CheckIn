...
@section('main_content')
    @if ($type == 'static')
        <div class="mt-2">
            <a href="https://i.imgur.com/7CK5yAn.jpg" target="_blank">
                <img src="https://i.imgur.com/7CK5yAn.jpg" class="img-fluid w-100">
            </a>
        </div>
        <div class="mt-2">
            <a href="https://i.imgur.com/WzyFs8Y.jpg" target="_blank">
                <img src="https://i.imgur.com/WzyFs8Y.jpg" class="img-fluid w-100">
            </a>
        </div>
        <div class="mt-2">
            <a href="https://i.imgur.com/OAzF98q.jpg" target="_blank">
                <img src="https://i.imgur.com/OAzF98q.jpg" class="img-fluid w-100">
            </a>
        </div>
    @elseif ($type == 'google')
