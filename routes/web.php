...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::any('/my-record-list', 'ApiController@myRecordList')->name('api.my-record-list');
    Route::post('/store-feedback/{club}', 'ApiController@storeFeedback')->name('api.store-feedback');
